...
- **Tests**: `npm test` at the root runs both workspaces. 966 API cases over
...
Open work is in the issue tracker. The whole breakdown of #1 is done —
#20–#37, #35 included — so what is left is the defects pinned in
