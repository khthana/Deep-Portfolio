...
response ของ e-Portfolio เก้า section (รายละเอียดส่วนตัว, ประวัติการศึกษา,
การอบรม, ใบประกาศ, รางวัล, ปริญญานิพนธ์, กิจกรรม, ฝึกงาน, ทักษะ) พร้อมรูปของ
ไฟล์แนบที่หก section ในนั้นใช้ร่วมกัน,
รูปของไฟล์แนบ (`AttachmentDetailResp`, `FileDetail`, `URLDetail`) และ
`StudentActivityStatusDB`
ฝั่ง web ยังเหลือไฟล์ type ที่เขียนเองอีก 33 ไฟล์ 1,620 บรรทัด (นับหลังรอบ
portfolio-skill 22 สิงหาคม 2569 ด้วย glob ที่ ADR-0028 ประกาศไว้ — ในนั้นมี type
