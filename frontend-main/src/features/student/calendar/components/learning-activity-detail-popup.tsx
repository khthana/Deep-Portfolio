...
const LearningActivityDetailPopup = (props: Props) => {
  return (
    <DetailPopup
        ...
        <div className="grid grid-cols-5">
          <div className="col-span-2 flex flex-col gap-2">
            ...
            <div className="flex gap-1">
              ...
              <img
                src={`${learningActivityStatusIcon[props.classworkDetail.status]}`}
                alt="status icon"
                width={16}
                height={16}
              />
...
export default LearningActivityDetailPopup;
