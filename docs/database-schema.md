...
เอกสารนี้บอกว่าแต่ละคอลัมน์*คืออะไร* ไม่ได้บอกว่า*ข้อมูลเข้าไปได้ทางไหน* — 28 ตารางในนั้นไม่มี write path ใน API เลย ต้องป้อนผ่าน CLI importer ดู [`importer.md`](./importer.md) ซึ่งมีลำดับการนำเข้า รูปแบบไฟล์ CSV ของแต่ละตาราง และบันทึกว่าตารางไหนมีข้อมูลจริงอยู่แล้วบ้าง
