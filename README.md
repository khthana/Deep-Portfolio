...
ปัจจุบันมี **1,030 เคสฝั่ง API** (40 ไฟล์ ยิงผ่าน HTTP เข้าหา Express app ตัวจริง) และ
**442 เคสฝั่งเว็บ** (31 ไฟล์ เฉพาะฟังก์ชันบริสุทธิ์) ทั้งหมดเขียนตามพฤติกรรมที่ระบบ
